...
{
	public class SettingsTest : IClassFixture<TempFolderFixture>
	{
		private readonly TempFolderFixture fixture;

		public SettingsTest(TempFolderFixture fixture)
		{
			this.fixture = fixture;
		}

		[Theory(DisplayName = "Test of the Settings property to enable the stage number on the first folder")]
		...
		[Theory(DisplayName = "Test of the Settings property to control the name of the config folder")]
		[InlineData("a")]
		[InlineData("config")]
		[InlineData("cfg")]
		...
		[Theory(DisplayName = "Test of the failing Settings property to control the name of the config folder")]
		...
		[Fact(DisplayName = "Test of the failing Settings property to control the name of the config folder on a protected system folder")]
		...
		[Theory(DisplayName = "Test of the failing Settings property to control the name of the config folder if it conflicts with the stage folders")]
		...
		[Theory(DisplayName = "Test of the Settings property to control the number of logged files when a purge is performed")]
		[InlineData(-1, 1, 1)]
		[InlineData(-1, 5, 5)]
		[InlineData(0, 1, 1)]
		[InlineData(0, 4, 1)]
		...
		[Theory(DisplayName = "Test of the failing Settings property to control the number of logged files, when the number is smaller -1")]
		[InlineData(-2)]
		[InlineData(-5)]
		[InlineData(-10)]
		...
		[Theory(DisplayName = "Test of the Settings property to enable logging of moved/purged files when a purge is performed")]
		[InlineData(false)]
		[InlineData(true)]
		...
		[Theory(DisplayName = "Test of the Settings property to enable logging in general")]
		[InlineData(false)]
		[InlineData(true)]
		...
		[Theory(DisplayName = "Test of the Settings property to control the name of the logging folder")]
		[InlineData("a")]
		[InlineData("logging")]
		[InlineData("log")]
		...
		[Theory(DisplayName = "Test of the failing Settings property to control the name of the logging folder")]
		[InlineData("NUL", "purge-temp")]
		[InlineData("<", "purge-temp")]
		[InlineData("\t", "purge-temp")]
		...
		[Fact(DisplayName = "Test of the failing Settings property to control the name of the logging folder, on a protected system, folder")]
		...
		[Theory(DisplayName = "Test of the failing Settings property to control the name of the logging folder if it conflicts with the stage folders")]
		[InlineData("purge-temp-LAST", "purge-temp")]
		[InlineData("purge-temp", "purge-temp")]
		...
		[Theory(DisplayName = "Test of the failing Settings property to control the number of logfile bytes until a new logfile is created")]
		[InlineData(1, 0, 1)]
		[InlineData(10, 0, 1)]
		[InlineData(1 , 10, 1)]
		[InlineData(2 , 10 , 2)]
		...
		[Theory(DisplayName = "Test of the failing Settings property to control the number of logfile bytes until a new logfile is created, when the number is negative")]
		[InlineData(-1)]
		[InlineData(-2)]
		[InlineData(-5)]
		[InlineData(-10)]
		...
		[Theory(DisplayName = "Test of the failing Settings property to control the number of logfiles to retain during the log rotation")]
		[InlineData(1, 1, 1)]
		[InlineData(10, 1, 1)]
		[InlineData(10, 3, 3)]
		[InlineData(5, 7, 5)]
		...
		[Theory(DisplayName = "Test of the failing Settings property to control the number of logfiles to retain during the log rotation, when the number is negative")]
		[InlineData(-1)]
		[InlineData(-2)]
		[InlineData(-5)]
		[InlineData(-10)]
		...
		[Theory(DisplayName = "Test of the Settings property to set a valid logo file")]
        ...
        [Theory(DisplayName = "Test of the failing Settings property to set a valid logo file")]
        [InlineData("NUL")]
        [InlineData("<")]
        [InlineData("\t")]
        [InlineData("file ")]
        ...
        [Theory(DisplayName = "Test of the Settings property to remove or keep empty stage folders")]
        ...
        [Theory(DisplayName = "Test of the Settings property to show desktop notifications on purge")]
        ...
        [Theory(DisplayName = "Test of the Settings property to skip purges by a skip token (file)")]
        ...
        [Theory(DisplayName = "Test of the failing Settings property to skip purges by a skip token (file)")]
        [InlineData("NUL")]
        [InlineData("<")]
        [InlineData("\t")]
        [InlineData("file ")]
        ...
        [Theory(DisplayName = "Test of the Settings property to control the name suffix of the last stage folder")]
        [InlineData("a")]
        [InlineData("LAST")]
        [InlineData(" LAST")]
        [InlineData("-")]
        ...
        [Theory(DisplayName = "Test of the Settings property to control the name suffix of the last stage folder with invalid values (auto-sanitation)")]
        [InlineData("NUL")]
        [InlineData("<")]
        [InlineData("\t")]
        [InlineData("LAST ")]
		...
		[Theory(DisplayName = "Test of the Settings property to control the name suffix of the last stage folder with invalid values (combind cases)")]
		[InlineData("NU","L")]
		[InlineData("LP", "T1")]
		[InlineData("P", "RN")]
		...
		[Theory(DisplayName = "Test of the Settings property to control the stage name prefix")]
		[InlineData("purge-temp")]
		[InlineData("a")]
		[InlineData("1")]
		[InlineData(".test")]
		...
		[Theory(DisplayName = "Test of the failing Settings property to control the stage name prefix")]
		[InlineData("")]
		...
		[Theory(DisplayName = "Test of the failing Settings property to control the stage name prefix for combined cases")]
		...
		[Theory(DisplayName = "Test of the Settings property to control the stage versions")]
		[InlineData(2)]
		[InlineData(4)]
		...
		[Theory(DisplayName = "Test of the failing Settings property to control the stage versions, when the number is zero or negative")]
		[InlineData(0)]
		[InlineData(-1)]
		[InlineData(-2)]
		[InlineData(-10)]
        ...
        [Theory(DisplayName = "Test of the Settings property to control the stage version delimiter")]
        [InlineData("-")]
        [InlineData("#")]
        [InlineData(" ")]
        [InlineData("")]
        ...
        [Theory(DisplayName = "Test of the Settings property to control the stage version delimiter when automatic sanitation is applied")]
        [InlineData("\"")]
        [InlineData("\\")]
        [InlineData("<")]
        [InlineData("NUL")]
        ...
        [Theory(DisplayName = "Test of the Settings property to control the number of seconds between purges")]
        [InlineData(1, 2, true)]
        [InlineData(2, 1, false)]
        [InlineData(0, 1, true)]
        [InlineData(2, 4, true)]
        [InlineData(4, 2, false)]
        public void StagingDelaySecondsTest(int givenSeconds, int delaySeconds, bool expectedCanExecute)
		{
            // Arrange
            string stageRootFolder = fixture.CreateUniqueTempFolder();
            // Create test settings with basic override
            Settings testSettings = ArrangeSettings(stageRootFolder);
            testSettings.OverrideSetting(Settings.Keys.StagingDelaySeconds, givenSeconds);
            testSettings.OverrideSetting(Settings.Keys.RemoveEmptyStageFolders, false);
            PurgeController purgeController = Program.GetTestEnvironment(testSettings);
            // Initial purge
            purgeController.ExecutePurge();
		...
		// ========== Direct Settings class unit tests ==========

		[Fact(DisplayName = "Test that Settings returns correct string property from configuration")]
		public void GetStringPropertyFromConfigTest()
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			Settings testSettings = ArrangeSettings(stageRootFolder);
			// StageNamePrefix is set to "purge-temp" by default in TestSettingsProvider
			Assert.Equal("purge-temp", testSettings.StageNamePrefix);
		}

		[Fact(DisplayName = "Test that Settings returns correct int property from configuration")]
		public void GetIntPropertyFromConfigTest()
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			Settings testSettings = ArrangeSettings(stageRootFolder);
			// StagingDelaySeconds is overridden to 2 in ArrangeSettings
			Assert.Equal(2, testSettings.StagingDelaySeconds);
		}

		[Fact(DisplayName = "Test that Settings returns correct bool property from configuration")]
		public void GetBoolPropertyFromConfigTest()
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			Settings testSettings = ArrangeSettings(stageRootFolder);
			// ShowPurgeMessage is set to false by default in TestSettingsProvider
			Assert.False(testSettings.ShowPurgeMessage);
		}

		[Fact(DisplayName = "Test that OverrideSetting with typed value returns the override")]
		public void OverrideSettingTypedValueTest()
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			Settings testSettings = ArrangeSettings(stageRootFolder);
			testSettings.OverrideSetting(Settings.Keys.StageVersions, 7);
			Assert.Equal(7, testSettings.StageVersions);
		}

		[Fact(DisplayName = "Test that OverrideSetting with string value is converted to the correct type")]
		public void OverrideSettingStringConversionTest()
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			Settings testSettings = ArrangeSettings(stageRootFolder);
			// Override an int property with a string value to exercise the string conversion branch
			testSettings.OverrideSetting(Settings.Keys.StageVersions, "5");
			Assert.Equal(5, testSettings.StageVersions);
		}

		[Theory(DisplayName = "Test that OverrideSetting with string value converts to bool")]
		...
		[InlineData("TRUE", true)]
		[InlineData("FALSE", false)]
        public void OverrideSettingStringToBoolConversionTest(string givenString, bool expectedBool)
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			Settings testSettings = ArrangeSettings(stageRootFolder);
			testSettings.OverrideSetting(Settings.Keys.LogEnabled, givenString);
			Assert.Equal(expectedBool, testSettings.LogEnabled);
		}

		[Fact(DisplayName = "Test that OverrideSetting with incompatible type throws InvalidCastException")]
		public void OverrideSettingInvalidCastTest()
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			Settings testSettings = ArrangeSettings(stageRootFolder);
			// Override an int property with a non-string, non-int object (e.g. a list)
			testSettings.OverrideSetting(Settings.Keys.StageVersions, new List<int> { 1, 2, 3 });
			Assert.Throws<InvalidCastException>(() => { int _ = testSettings.StageVersions; });
		}

		[Fact(DisplayName = "Test that OverrideSetting replaces a previous override")]
		public void OverrideSettingReplacesValueTest()
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			Settings testSettings = ArrangeSettings(stageRootFolder);
			testSettings.OverrideSetting(Settings.Keys.StageNamePrefix, "first");
			Assert.Equal("first", testSettings.StageNamePrefix);
			testSettings.OverrideSetting(Settings.Keys.StageNamePrefix, "second");
			Assert.Equal("second", testSettings.StageNamePrefix);
		}

		[Fact(DisplayName = "Test that TestEnvironmentMessage getter and setter work correctly")]
		public void TestEnvironmentMessageTest()
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			Settings testSettings = ArrangeSettings(stageRootFolder);
			Assert.Equal("", testSettings.TestEnvironmentMessage);
			testSettings.TestEnvironmentMessage = "test message";
			Assert.Equal("test message", testSettings.TestEnvironmentMessage);
		}

		[Fact(DisplayName = "Test that all property keys return values without exceptions")]
		public void AllPropertiesAccessibleTest()
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			Settings testSettings = ArrangeSettings(stageRootFolder);

			// Access every property to ensure no exceptions are thrown
			bool _ = testSettings.AppendNumberOnFirstStage;
			string _2 = testSettings.ConfigFolder;
			int _3 = testSettings.FileLogAmountThreshold;
			bool _4 = testSettings.LogAllFiles;
			bool _5 = testSettings.LogEnabled;
			string _6 = testSettings.LoggingFolder;
			int _7 = testSettings.LogRotationBytes;
			int _8 = testSettings.LogRotationVersions;
			string _9 = testSettings.PurgeMessageLogoFile;
			bool _10 = testSettings.RemoveEmptyStageFolders;
			bool _11 = testSettings.ShowPurgeMessage;
			string _12 = testSettings.SkipTokenFile;
			string _13 = testSettings.StageLastNameSuffix;
			string _14 = testSettings.StageNamePrefix;
			string _15 = testSettings.StageRootFolder;
			string _16 = testSettings.StageVersionDelimiter;
			int _17 = testSettings.StageVersions;
			int _18 = testSettings.StagingDelaySeconds;
			string _19 = testSettings.StagingTimestampFile;
			string _20 = testSettings.TempFolder;
			string _21 = testSettings.TimeStampFormat;
		}

		[Fact(DisplayName = "Test that Settings constructor with path loads settings via LoadSettings")]
		public void ConstructorWithPathTest()
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			string jsonContent = @"
			{
				""AppSettings"": {
					""StageNamePrefix"": ""loaded-prefix"",
					""StageVersions"": ""3"",
					""StageVersionDelimiter"": ""-"",
					""StagingDelaySeconds"": ""10"",
					...
					""StageRootFolder"": """ + stageRootFolder.Replace("\\", "\\\\") + @""",
			...
			IConfiguration configuration = new ConfigurationBuilder()
				...
				.Build();
			Settings settings = new Settings(configuration, stageRootFolder);
			// LoadSettings should have populated the overrides from the configuration
			Assert.Equal("loaded-prefix", settings.StageNamePrefix);
			Assert.Equal(3, settings.StageVersions);
		}

		[Fact(DisplayName = "Test that OverrideSetting with bool type returns bool directly")]
		public void OverrideSettingBoolDirectTest()
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			Settings testSettings = ArrangeSettings(stageRootFolder);
			testSettings.OverrideSetting(Settings.Keys.AppendNumberOnFirstStage, true);
			Assert.True(testSettings.AppendNumberOnFirstStage);
			testSettings.OverrideSetting(Settings.Keys.AppendNumberOnFirstStage, false);
			Assert.False(testSettings.AppendNumberOnFirstStage);
		}

		[Theory(DisplayName = "Test that OverrideSetting with string override for string property returns the value directly")]
		[InlineData("test-prefix")]
		[InlineData("")]
		[InlineData("special-chars-!@#")]
		public void OverrideSettingStringPropertyTest(string givenValue)
		{
			string stageRootFolder = fixture.CreateUniqueTempFolder();
			Settings testSettings = ArrangeSettings(stageRootFolder);
			testSettings.OverrideSetting(Settings.Keys.StageNamePrefix, givenValue);
			Assert.Equal(givenValue, testSettings.StageNamePrefix);
		}
